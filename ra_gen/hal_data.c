...
sci_uart_instance_ctrl_t     g_uart9_ctrl;
            ...
            {
                /* Baud rate calculated with 4.632% error. */ .semr_baudrate_bits_b.abcse = 0, .semr_baudrate_bits_b.abcs = 0, .semr_baudrate_bits_b.bgdm = 1, .cks = 0, .brr = 13, .mddr = (uint8_t) 256, .semr_baudrate_bits_b.brme = false
            };
